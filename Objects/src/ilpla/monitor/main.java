...
//C
this.state = 10;
 //BA.debugLineNum = 67;BA.debugLine="ToastMessageShow(\"No permissions set\", False)";
...
anywheresoftware.b4a.keywords.Common.LogImpl("8131082","No Permission: "+_permission,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("8131087","All permissions OK",0);
 if (true) break;
;
...
//C
this.state = 1;
 //BA.debugLineNum = 240;BA.debugLine="Msgbox2Async(\"Sure you want to permanently close";
...
if ((mostCurrent._txttelefonos.getText()).equals("")) { 
 //BA.debugLineNum = 204;BA.debugLine="ToastMessageShow(\"No phone numbers configured...";
...
_monitoron = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 212;BA.debugLine="ToastMessageShow(\"Energy monitor on\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Energy monitor on"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 213;BA.debugLine="lblMonitorOn.Text = \"Monitor ON\"";
mostCurrent._lblmonitoron.setText(BA.ObjectToCharSequence("Monitor ON"));
 //BA.debugLineNum = 214;BA.debugLine="btnMonitorOn.Text = \"OFF\"";
...
_monitoron = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 221;BA.debugLine="ToastMessageShow(\"Energy monitor off\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Energy monitor off"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 222;BA.debugLine="lblMonitorOn.Text = \"Monitor OFF\"";
mostCurrent._lblmonitoron.setText(BA.ObjectToCharSequence("Monitor OFF"));
 //BA.debugLineNum = 223;BA.debugLine="btnMonitorOn.Text = \"ON\"";
...
_telefonos = mostCurrent._txttelefonos.getText();
 //BA.debugLineNum = 104;BA.debugLine="ToastMessageShow(\"Config saved!\", False)";
...
if (_hayenergia==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 169;BA.debugLine="ToastMessageShow(\"Energy back, sending SMS...\",";
...
int _i = 0;
 ...
 //BA.debugLineNum = 136;BA.debugLine="ToastMessageShow(\"Sending SMS for power off...\",";
