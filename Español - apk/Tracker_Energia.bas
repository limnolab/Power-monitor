...
Sub CreateNotification (Body As String) As Notification
	...
	notification.SetInfo("Monitoreando luz", Body, Main)
	Return notification
End Sub
	...
	If Plugged = False Then
		...
		If Main.monitorOn = True Then
			...
			If estadoAnterior = True Then
				ToastMessageShow("Se cortó la luz! Esperando para enviar SMS", True)
	...
	Else If Plugged = True Then
		...
		If Main.monitorOn = True Then
			...
			If estadoAnterior = False Then
				ToastMessageShow("Volvió la luz! Esperando para enviar SMS", True)
