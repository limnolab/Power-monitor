...
_notification.setIcon("icon");
 //BA.debugLineNum = 29;BA.debugLine="notification.SetInfo(\"Monitoreando luz\", Body, Ma";
_notification.SetInfoNew(processBA,BA.ObjectToCharSequence("Monitoreando luz"),BA.ObjectToCharSequence(_body),(Object)(mostCurrent._main.getObject()));
...
if (_estadoanterior==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 46;BA.debugLine="ToastMessageShow(\"Se cortó la luz! Esperando p";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Se cortó la luz! Esperando para enviar SMS"),anywheresoftware.b4a.keywords.Common.True);
...
if (_estadoanterior==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 58;BA.debugLine="ToastMessageShow(\"Volvió la luz! Esperando par";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Volvió la luz! Esperando para enviar SMS"),anywheresoftware.b4a.keywords.Common.True);
