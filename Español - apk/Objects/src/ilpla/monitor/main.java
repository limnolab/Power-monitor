...
//C
this.state = 10;
 //BA.debugLineNum = 66;BA.debugLine="ToastMessageShow(\"Faltan permisos\", False)";
...
//C
this.state = 1;
 //BA.debugLineNum = 239;BA.debugLine="Msgbox2Async(\"Seguro que querés salir, se apagará";
...
if ((mostCurrent._txttelefonos.getText()).equals("")) { 
 //BA.debugLineNum = 203;BA.debugLine="ToastMessageShow(\"No hay números configurados...";
...
_monitoron = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 211;BA.debugLine="ToastMessageShow(\"Monitor prendido\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Monitor prendido"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 212;BA.debugLine="lblMonitorOn.Text = \"Monitor PRENDIDO\"";
mostCurrent._lblmonitoron.setText(BA.ObjectToCharSequence("Monitor PRENDIDO"));
 //BA.debugLineNum = 213;BA.debugLine="btnMonitorOn.Text = \"APAGADO\"";
...
_monitoron = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 220;BA.debugLine="ToastMessageShow(\"Monitor apagado\", False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Monitor apagado"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 221;BA.debugLine="lblMonitorOn.Text = \"Monitor APAGADO\"";
mostCurrent._lblmonitoron.setText(BA.ObjectToCharSequence("Monitor APAGADO"));
 //BA.debugLineNum = 222;BA.debugLine="btnMonitorOn.Text = \"PRENDIDO\"";
...
_telefonos = mostCurrent._txttelefonos.getText();
 //BA.debugLineNum = 103;BA.debugLine="ToastMessageShow(\"Configuración guardada!\", False";
...
if (_hayenergia==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 168;BA.debugLine="ToastMessageShow(\"Volvió la luz, enviando SMS...";
...
int _i = 0;
 ...
 //BA.debugLineNum = 135;BA.debugLine="ToastMessageShow(\"Enviando SMS - Corte de luz...\"";
